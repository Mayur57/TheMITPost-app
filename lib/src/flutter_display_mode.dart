...
/// Utility to get resolution and refresh rate modes from the host device
/// Best possible mode is selected from the list of modes before the
/// commencing of the runtime of the app
